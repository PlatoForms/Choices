...
var Choices = /** @class */function () {
  function Choices(element, userConfig) {
    ...
    if (this.passedElement.options) {
      this.passedElement.options.forEach(function (option) {
        var c_properties = (0, utils_1.parseCustomProperties)(option.dataset.customProperties);
        if (_this.config.getOptionAttrByKeys && _this.config.getOptionAttrByKeys.length > 0) {
          _this.config.getOptionAttrByKeys.forEach(function (option_attr_key) {
            var option_attr_val = option.getAttribute(option_attr_key);
  ...
  Choices.prototype.showDropdown = function (preventInputFocus) {
    ...
    var xmlDecode = function (str) {
      var doc = new DOMParser().parseFromString(str, 'text/html');
      var val = doc.documentElement.textContent;
      if (val) {
        return val;
      }
      return '';
  ...
  Choices.prototype.setChoiceByValue = function (value) {
    ...
    if (Array.isArray(value) && value.length <= 0 || value === null) {
      this._store.activeItems.forEach(function (item) {
        return _this._removeItem(item);
      });
...
exports.defaultState = void 0;
var redux_1 = __webpack_require__(591);
